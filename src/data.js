...
export const FIGURES = {
  'Waltz': [
    ...
    { n: 'Basic Weave',            c: '1-2-3,1-2-3', fw: 'TH,HT,TH,TH,T,TH',  al: 'BDW,BDW,BLOD,BDC,BDC,PDW', sw: 'S,S,S,S,S,S', rise: 'Rise e/o 2, top 3&4, lower e/o 3/6',  notes: 'Backing figure. Step 2 fwd against LOD.' },
    { n: 'Closed Telemark',        c: '1-2-3',       fw: 'HT,T,TH',            al: 'FDC,BLOD,FDW',         sw: 'S,L,S',       rise: 'Rise e/o 1, top 2&3, lower e/o 3',    notes: 'CBM on 1. Leads heel turn for lady.' },
    { n: 'Closed Wing',            c: '1-2-3',       fw: 'H,WF,WF',            al: 'FDC,FDC,FDC',          sw: 'S,S,S',       rise: 'No rise',                              notes: 'OP on step 1. Lady closes to man.' },
    { n: 'Fallaway Whisk',         c: '1-2-3',       fw: 'TH,TH,TH',           al: 'BLOD,BDC,FDC',         sw: 'S,S,R',       rise: 'Rise e/o 1, top 2&3, lower e/o 3',    notes: 'Ends in Fallaway PP.' },
    { n: 'Left Whisk',             c: '1-2-3',       fw: 'H,TH,T',             al: 'FDW,FDW,FDW',          sw: 'S,S,S',       rise: 'No rise',                              notes: 'Man steps RF across in PP. Ends in PP.' },
    { n: 'Open Impetus and Cross Hesitation', c: '1-2-3,1-2-3', fw: 'TH,HT,TH,HT,TT,TH', al: 'BLOD,FDC,FDC,FDC,FDC,FDC', sw: 'S,L,S,S,S,S', rise: 'Rise e/o 2, top 3&5, lower e/o 6', notes: 'Open Impetus bar 1, Cross Hesitation bar 2.' },
    { n: 'Open Impetus and Wing',  c: '1-2-3,1-2-3', fw: 'TH,HT,TH,H,WF,WF',  al: 'BLOD,FDC,FDC,FDC,FDC,FDC', sw: 'S,L,S,S,S,S', rise: 'Rise e/o 2, top 3&5, lower e/o 6', notes: 'Open Impetus bar 1, Wing bar 2.' },
    { n: 'Open Telemark and Cross Hesitation', c: '1-2-3,1-2-3', fw: 'HT,T,TH,HT,TT,TH', al: 'FDC,BDW,FDW,FDW,FDW,FDW', sw: 'S,L,S,S,S,S', rise: 'Rise e/o 1, top 2-5, lower e/o 6', notes: 'Open Telemark bar 1, Cross Hesitation bar 2.' },
    { n: 'Open Telemark and Wing', c: '1-2-3,1-2-3', fw: 'HT,T,TH,H,WF,WF',   al: 'FDC,BDW,FDW,LOD,FDC,FDC', sw: 'S,L,S,S,S,S', rise: 'Rise e/o 1, top 2-5, lower e/o 6', notes: 'Open Telemark bar 1, Wing bar 2.' },
    { n: 'Reverse Corté',          c: '1-2-3',       fw: 'TH,H,TH',            al: 'BLOD,BDC,BDC',         sw: 'S,S,R',       rise: 'Rise e/o 1, top 2, lower e/o 3',      notes: 'Back, close without weight, hold.' },
    { n: 'Reverse Pivot',          c: '&',           fw: 'THT',                 al: 'DC',                   sw: 'S',           rise: 'Up',                                   notes: 'Single pivot on &. Foot turned in.' },
    { n: 'Turning Lock to R',      c: '1-&-2-3',     fw: 'TH,T,T,TH',          al: 'BDC,BDC,FDW,FDW',     sw: 'S,S,S,S',     rise: 'Rise e/o 1, top 2&3, lower e/o 3',    notes: 'Turning lock rotating to right.' },
    { n: 'Weave from PP',          c: '1-2-3,1-2-3,1', fw: 'HT,HT,TH,TH,T,TH,H', al: 'FDC,FC,BLOD,BDC,BDC,PDW,FDW', sw: 'S,S,S,S,S,S,S', rise: 'Rise e/o 1, top 2&5, lower e/o 3/6', notes: 'From PP. 3 bars. Ends OP.' },
  ],
}
...
export const FIGURE_RICH_DATA = {
  ...
  'Open Impetus and Wing': {
    bars: 2,
    leader: [
      { bar: 1, count: '1', foot: 'LF back', alignment: 'BLOD', footwork: 'TH', turn: 'start to turn R', sway: 'Sway(S)', rise: 'CBM | -- This is "Open Impetus"', notes: 'Do not dissolve the sway from previous Natural Turn. Maintain the sway through the heel turn (longer than you normally would.)' },
      { bar: 1, count: '2', foot: 'RF closes to LF (Heel Turn)', alignment: 'FDC', footwork: 'HT', turn: '3/8 btwn 1-2', sway: 'Sway(L)', rise: 'rise e/o 2 Rise through the diagonal of the body. Rotate the body pass the base and stretch the right side. Head is forward, sending body diagonally back, changing angle.', notes: 'Do not lift foot. Keep foot very flat during heel turn, ball of feet just free enough to swivel.' },
      { bar: 1, count: '3', foot: 'LF diag. fwd in PP, L side leading', alignment: 'Pointing DC, body facing LOD', footwork: 'TH', turn: 'slight body turn to R', sway: 'Sway(S)', rise: 'up, lower e/o 3', notes: '' },
      { bar: 2, count: '1', foot: 'RF fwd in PP and CBMP', alignment: 'Pointing DC, body facing LOD', footwork: 'H', turn: '--', sway: 'Sway(S)', rise: '-- This is "Wing".', notes: 'Start swaying to right, smooth transition through the measure, not producing sway in one beat.' },
      { bar: 2, count: '2', foot: 'LF start to close to RF', alignment: 'towards alignment of step 6', footwork: 'Pressure on T of RF with foot flat, and pressure on IE of T (LF)', turn: 'body turn to L on 5', sway: 'Sway(S)', rise: 'slight rise on 5 and 6, NFR Body is slightly rotated to left to allow Lady to pass the hip.', notes: '' },
      { bar: 2, count: '3', foot: 'LF closes to RF w/o weight', alignment: 'FDC', footwork: 'same as step 5', turn: 'body turn to L on 6', sway: 'Sway(S)', rise: '--', notes: '' },
    ],
    follower: [
      { bar: 1, count: '1', foot: 'RF fwd', alignment: 'Facing LOD', footwork: 'HT', turn: 'start to turn R', sway: 'Sway(S)', rise: 'CBM This is "Open Impetus". Keep right side positive. Right side connected to Man.', notes: '' },
      { bar: 1, count: '2', foot: 'LF to side', alignment: 'BDC', footwork: 'T', turn: '3/8 to R btwn 1-2', sway: 'Sway(R)', rise: 'rise e/o 2 Right front is still positive, do not pull R shoulder away. Allow base to turn first, turn feet underneath the body, head the last to turn. Create soft action. Try not to anticipate promenade and turn too early. Delay the turn. Turn through the feet first.', notes: '' },
      { bar: 1, count: '3', foot: 'RF to side in PP, having brushed to LF', alignment: 'Pointing to center (moving DC)', footwork: 'TH', turn: '3/8 btwn 2-3, body turns less', sway: 'Sway(S)', rise: 'up, lower e/o 3 Feel the turn, delay the head.', notes: 'Develop strong left side stretch at the end.' },
      { bar: 2, count: '1', foot: 'LF fwd in PP and CBMP', alignment: 'BDW', footwork: 'HT', turn: '1/8 to L btwn 3-4', sway: 'Sway(S)', rise: 'CBM | start to rise e/o 4 This is "Wing".', notes: 'Big step. Don\'t change sway too soon. At end of count 1, hip is just about square. As you land on L leg. L shoulder becomes the swing point, it\'s preference whether you want to get swing going early.' },
      { bar: 2, count: '2', foot: 'RF fwd preparing to step OP on L side', alignment: 'BLOD', footwork: 'T', turn: '1/8 btwn 4-5', sway: 'Sway(L)', rise: 'cont to rise on 5 Right side leading.', notes: 'Small steps on 2 and 3, walk closely around Man, do not travel too far away from Man. Try not to gap with Man. Going to the wrong position, Lady\'s Left side connects with Man\'s Left side. Head dances "up and over" the bar (where bra strap is). Do not collapse back muscle. Feel a strong upward curved. Pick up the center. Take head back. Feel that you are in a lengthened, picked up position. By the end of Count 2, head will be "square" to Man, closed.' },
      { bar: 2, count: '3', foot: 'LF fwd in CBMP, OP on L side', alignment: 'BDC', footwork: 'TH', turn: '1/8 btwn 5-6', sway: 'Sway(L)', rise: 'up, lower e/o 6 Allow arms to become part of Man\'s shape. Elbows forward and head back.', notes: 'Ending in Wrong Position: Lady head quadrant should still be on Man\'s right side, but hips and feet are on wrong side. Do not go too far to Man\'s left, which will make next step difficult. Two ways to do shaping: Slower, more gradual turning head to head over 1-2-3. Faster, sharper turning: all happens on 1' },
    ],
    techniqueNotes: '',
  },
